...
pdfjam --nup 3x1 figures/gradient_parameters.pdf figures/evolution_parameters.pdf figures/heuristic_parameters.pdf --landscape --outfile figures/joss/optimisers_parameters.pdf --papersize '{920px,1440px}'
