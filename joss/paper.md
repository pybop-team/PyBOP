...
![Cost landscape contour plot with corresponding optimisation traces, for several optimisers. \label{fig:optimiser-inference2}](figures/joss/contour_subplot.png){ width=100% }
...
![Gravimetric energy density cost landscape alongside the initial and optimised voltage profiles, for a fixed 1C discharge set from the initial design. \label{fig:design_gravimetric}](figures/joss/design.png){ width=100% }
