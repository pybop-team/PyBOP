...
package (\citeproc{ref-Sulzer:2021}{Sulzer et al., 2021}). Using the
...
et al., 2023}; \citeproc{ref-Lu:2021}{Lu et al., 2021}).
...
procedure is available in (\citeproc{ref-pybamm-eis}{Dhoot et al.,
n.d.}). The \autoref{fig:impedance-landscape} below shows the numerical
