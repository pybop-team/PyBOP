...
parameterisation},
  pdfauthor={Brady Planden, Nicola E. Courtier, Martin Robinson, Ferran
Brosa Planella, David A. Howey},
  pdflang={en-US},
  colorlinks=true,
  linkcolor={Maroon},
  filecolor={Maroon},
...
\affil[4]{Mathematics Institute, University of Warwick, Coventry, UK%
  }
...
(\citeproc{ref-Sulzer:2021}{Sulzer et al., 2021}).
...
(\citeproc{ref-Clerx:2019}{Clerx et al., 2019}), \texttt{SciPy}
(\citeproc{ref-SciPy:2020}{Virtanen et al., 2020}), in addition to the
PyBOP's own algorithms such as Adaptive Moment Estimation with Weight
Decay (AdamW), and Cuckoo search.

\texttt{PyBOP} supports the Battery Parameter eXchange (BPX) standard
(\citeproc{ref-BPX:2023}{Korotkin et al., 2023}) for sharing battery
...
(\citeproc{ref-jax:2018}{Bradbury et al., 2018}) numerical solvers
...
(\citeproc{ref-numpyro:2019}{Phan et al., 2019}), BlackJAX
(\citeproc{ref-blackjax:2024}{Cabezas et al., 2024}), and Optax
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2604}}@{}}
...
particle model (SPM) (\citeproc{ref-Planella:2022}{Planella et al.,
2022}), and the multi-species, multi-reaction (MSMR) model
...
measurable outputs (\citeproc{ref-Andersson:2022}{Andersson et al.,
...
\caption{The cost landscape for the parameterisation problem with a root
mean squared error cost function. \label{fig:inference-time-landscape}}
\end{figure}
...
(\citeproc{ref-DiffEvolution:2006}{Braak, 2006}), and finally
conventional methods based on random sampling with rejection criteria
(\citeproc{ref-metropolis:1953}{Metropolis et al., 1953}). PyBOP offers
...
(\citeproc{ref-Haario:2001}{Haario et al., 2001}).
...
parameters (\citeproc{ref-Couto:2023}{Couto et al., 2023}). For this
