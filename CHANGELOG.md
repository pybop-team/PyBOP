...
- [#672](https://github.com/pybop-team/PyBOP/pull/672) - Removes pybamm model events by default, removes `allow_infeasible_solutions` from optimisers and adds `infeasible_solutions` arg to problem classes.
