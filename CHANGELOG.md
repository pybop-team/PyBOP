...
- [#424](https://github.com/pybop-team/PyBOP/issues/424) - Enables the option to pass an initial OCV value to `FittingProblem` and updates `BaseModel` for consistency.
