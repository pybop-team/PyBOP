...
# In this example, we introduce the Cuckoo
# optimisation algorithm. Cuckoo is a population-based
# algorithm which explores the search space by randomly
# suggesting candidates "nests" and  abandoning poorly
