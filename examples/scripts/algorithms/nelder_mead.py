...
# In this example, we introduce the Nelder-Mead
# algorithm. Alternatively, known as the downhill
# simplex method, it's a heuristic method that
# does not use gradient information. Nelder-Mead
# is a conventionally robust implementation for
# optimisation in electrochemical problems.
